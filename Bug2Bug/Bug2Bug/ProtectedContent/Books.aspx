...
<p>
      <asp:GridView ID="titlesGridView" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="titlesGridView_SelectedIndexChanged" AllowPaging="True" OnPageIndexChanging="titlesGridView_PageIndexChanging" PageSize="4">
   ...
   <p>
       <asp:LinkButton ID="cartBtn" runat="server" PostBackUrl="~/ProtectedContent/Order.aspx">Go to Cart</asp:LinkButton>
    </p>
</asp:Content>
